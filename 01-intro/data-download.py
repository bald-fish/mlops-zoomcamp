...
def main():
    ...
    url_1 = 'https://d37ci6vzurychx.cloudfront.net/trip-data/yellow_tripdata_2023-01.parquet'
    url_2 = 'https://d37ci6vzurychx.cloudfront.net/trip-data/yellow_tripdata_2023-02.parquet'
    url_list = [url_1, url_2]
    destination_folder = '../01-intro/data'
